...
$getUpdates = Install-WindowsUpdate -Install -UpdateType Driver -MicrosoftUpdate -ForceDownload -ForceInstall -IgnoreReboot  -AcceptAll -SendHistory -Criteria "isinstalled=0 and deploymentaction=*"
